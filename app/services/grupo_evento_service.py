...
class GrupoEventoService:
    ...
    def registrar(self, user_id: int, jid_grupo: str, acao: str,
        ...
        if not grupo.ativado:
            # Monitoramento é só de grupo ATIVADO pela usuária (spec §6.2):
            # nem contador nem evento — silêncio de propósito, o webhook
            # continua chegando para os grupos que ela não ligou.
            return 0
